...
public class DBServer extends AbstractServer {
	...
	public void handleMessageFromClient(Object msg, ConnectionToClient client) {
		...
		if (msg instanceof MessageObject) {
			...
			case NewChangeRequest:
				handleNewChange(message,client);
				break;
			}
	...
	public void handleNewChange(MessageObject message, ConnectionToClient client) {
		...
		boolean res= mysqlConnection.addCRToDB(formysql.get(1).toString(),"555","first",formysql.get(5).toString(),"ongoing","handler");
	...
	public static boolean startServer() {
		int port = DEFAULT_PORT; // Port to listen on - default is 5555
